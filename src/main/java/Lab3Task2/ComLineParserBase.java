...
public class ComLineParserBase {
    ...
    // protected, SwitchStatus может быть доступен из любого места внутри того же пакета, а также из подклассов (наследников) даже в других пакетах
    ...
    protected void OnUsage(String errorKey) { // protected - метод должен быть переопределен в классах наследниках
    }
    ...
    protected SwitchStatus OnSwitch(String key, String keyValue) {
     ...
     final Boolean Parse(String[] args) { // final метод не может быть переопределен в наследниках
